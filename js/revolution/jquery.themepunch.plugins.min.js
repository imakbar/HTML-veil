...
jQuery(function($){
	...
	if($.fn.revolution){
		$('.is-revolution-slider').revolution({
						dottedOverlay:"none",
						delay:16000,
						startwidth:1210,
						startheight:500,
	...
	//Region Revolution Slider	
	if($.fn.revolution){
		$('.is-fullscreen-revolution-slider').revolution({
						dottedOverlay:"none",
						delay:16000,
						startwidth:1170,
						startheight:600,
	...
	//Region Revolution Slider
	/*if($.fn.revolution){
		$('.is-revolution-slider-left-header').revolution({
			delay:9000,
			startwidth:1000,
			startheight:500,
			hideThumbs:10,
	...
	//Region Revolution Slider
	/*if($.fn.revolution){
		$('.is-revolution-slider-right-header').revolution({
						dottedOverlay:"none",
						delay:16000,
						startwidth:1000,
						startheight:500,
