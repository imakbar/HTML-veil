! function() {
    ...
    $(document).ready(function() {
        var a, e, s, o;
        return e = "css/colors/", o = $("#style-switcher"), o.find(".custom_icon").click(function() {
            ...
            return !1
        }), a = localStorage.getItem("colors"), null !== a && o.find(".style-switcher-color[data-switch-to='" + a + "']").length > 0 && ($("#colors").attr("href", "" + e + a), t(o.find("[data-switch-to='" + a + "']"))), s = localStorage.getItem("layout"), null !== s && o.find(".style-switcher-button[data-switch-to='addClass:" + s + "']").length > 0 ? ($(".switcher_boxed").addClass(s), t(o.find("[data-switch-to='addClass:" + s + "']"))) : void 0
    }), t = function(t) {
